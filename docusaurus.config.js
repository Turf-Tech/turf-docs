...
const config = {
  ...
  themeConfig:
    ...
    ({
      ...
      announcementBar: {
        content:
          '<a target="_blank" rel="noopener noreferrer" href="https://0xturf.gg">← Back to Turf App</a>',
        isCloseable: false,
      },
      docs: {
        sidebar: {
      ...
      navbar: {
        ...
        items: [
          {
            href: "https://github.com/turf-tech",
          ...
          {
            href: "https://0xturf.gg",
            className: "ignt-backlink",
            label: `Back to Turf App`,
            position: "right",
          },
          {
